...
@Named
public class RelativeToParentWidthFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return RelativeToParentWidthFilter.class;
    }

    @Override
    public String getAttributeName()
    {
        return "Relative to parent width";
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.RELATIVE_TO_PARENT_WIDTH;
    }
}
