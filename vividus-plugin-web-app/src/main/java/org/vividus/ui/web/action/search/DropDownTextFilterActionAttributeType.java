...
@Named
public class DropDownTextFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return DropDownTextFilter.class;
    }

    @Override
    public String getAttributeName()
    {
        return "Drop down text";
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.DROP_DOWN_TEXT;
    }
}
