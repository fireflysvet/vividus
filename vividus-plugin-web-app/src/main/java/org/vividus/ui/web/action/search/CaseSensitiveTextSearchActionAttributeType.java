...
@Named
public class CaseSensitiveTextSearchActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return CaseSensitiveTextSearch.class;
    }

    @Override
    public String getAttributeName()
    {
        return "Case sensitive text";
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.CASE_SENSITIVE_TEXT;
    }
