...
@Named
public class PlaceholderFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return PlaceholderFilter.class;
    }
    ...
    {
        return WebActionAttributeType.PLACEHOLDER;
    }
}
