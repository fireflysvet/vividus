...
@Named
public class FieldNameActionAttributeType extends AbstractActionAttributeType
{
    @Override
    ...
    public Function<SearchParameters, By> getSearchLocatorBuilder()
    {
     // due to firefox bug, we can't use name() and must use local-name() as workaround 'body' represents CKE editor
        return parameters -> LocatorUtil.getXPathLocator(".//*[(local-name() = 'input' or local-name() = 'textarea' or "
    ...
    {
        return WebActionAttributeType.FIELD_NAME;
    }
}
