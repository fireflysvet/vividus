...
@Named
public class CssSelectorActionAttributeType extends AbstractActionAttributeType
{
    @Override
    ...
    {
        return parameters -> How.CSS.buildBy(parameters.getValue());
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.CSS_SELECTOR;
    }
}
