...
@Named
public class ValidationIconSourceFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return ValidationIconSourceFilter.class;
    }

    @Override
    public String getAttributeName()
    {
        return "Validation icon source";
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.VALIDATION_ICON_SOURCE;
    }
}
