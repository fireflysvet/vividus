...
@Named
public class ElementNameSearchActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return ElementNameSearch.class;
    }
    ...
    {
        return WebActionAttributeType.ELEMENT_NAME;
    }
}
