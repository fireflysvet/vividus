...
@Named
public class FieldTextPartFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return FieldTextPartFilter.class;
    }

    @Override
    public String getAttributeName()
    {
        return "Field text part";
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.FIELD_TEXT_PART;
    }

    @Override
    public IActionAttributeKey getCompetingTypeAttributeKey()
    {
        return WebActionAttributeType.FIELD_TEXT;
    }
}
