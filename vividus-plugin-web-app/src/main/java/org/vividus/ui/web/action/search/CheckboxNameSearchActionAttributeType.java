...
@Named
public class CheckboxNameSearchActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return CheckboxNameSearch.class;
    }
    ...
    {
        return WebActionAttributeType.CHECKBOX_NAME;
    }
}
