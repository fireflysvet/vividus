...
@Named
public class ClassAttributePartFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return ClassAttributePartFilter.class;
    }

    @Override
    public String getAttributeName()
    {
        return "Attribute class part";
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.CLASS_ATTRIBUTE_PART;
    }
}
