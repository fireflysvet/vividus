...
@Named
public class ImageSrcActionAttributeType extends AbstractActionAttributeType
{
    @Override
    ...
    {
        return parameters -> LocatorUtil.getXPathLocator(".//img[@src='%s']", parameters.getValue());
    }
