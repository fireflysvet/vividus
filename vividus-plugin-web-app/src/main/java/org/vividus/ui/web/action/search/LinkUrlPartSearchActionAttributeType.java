...
@Named
public class LinkUrlPartSearchActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return LinkUrlPartSearch.class;
    }
    ...
    {
        return WebActionAttributeType.LINK_URL_PART;
    }

    @Override
    public IActionAttributeKey getCompetingTypeAttributeKey()
    {
        return WebActionAttributeType.LINK_URL;
    }
}
