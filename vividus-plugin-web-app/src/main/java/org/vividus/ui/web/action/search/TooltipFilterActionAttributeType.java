...
@Named
public class TooltipFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    ...
    {
        return parameters -> LocatorUtil.getXPathLocator(".//*[@title=%s]", parameters.getValue());
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.TOOLTIP;
    }
}
