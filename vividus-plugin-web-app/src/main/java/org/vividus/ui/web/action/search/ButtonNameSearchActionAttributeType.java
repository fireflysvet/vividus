...
@Named
public class ButtonNameSearchActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return ButtonNameSearch.class;
    }
    ...
    {
        return WebActionAttributeType.BUTTON_NAME;
    }
}
