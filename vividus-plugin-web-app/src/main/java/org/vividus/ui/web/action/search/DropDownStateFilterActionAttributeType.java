...
@Named
public class DropDownStateFilterActionAttributeType extends AbstractActionAttributeType
{
    @Override
    public Class<? extends IElementAction> getActionClass()
    {
        return DropDownStateFilter.class;
    }

    @Override
    public String getAttributeName()
    {
        return "Drop down state";
    }

    @Override
    public IActionAttributeKey getAttributeKey()
    {
        return WebActionAttributeType.DROP_DOWN_STATE;
    }
}
